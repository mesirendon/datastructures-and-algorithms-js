...
describe("Linked lists", () => {
  ...
  describe("Linked list", () => {
    ...
    it("should find node by callback", () => {
      ...
      expect(linkedList.find({ callback: (value) => value.key === "test5" })).to
        .be.null;
    });
    ...
    it("should find node by means of custom compare function", () => {
      ...
      expect(linkedList.find({ value: { value: 2, customValue: "test5" } })).to
        .be.null;
    });
    ...
    it("should tell the linked list size at any moment", () => {
      ...
      linkedList.append(1).append(2).append(2).append(3).append(3);
      ...
      linkedList.prepend(1).prepend(1);
      ...
      linkedList.insert(4, 3).insert(0, -4).insert(10, 40);
